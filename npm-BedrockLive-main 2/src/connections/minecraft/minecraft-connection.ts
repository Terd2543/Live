...
export default class MinecraftConnection extends EventEmitter {
    ...
    private readonly _minecraftWss: WebSocketServer;
    private readonly _commandHandler: MinecraftCommandHandler;
    private _activeClient: WebSocket | undefined;
    
    private constructor(minecraftWss: WebSocketServer) {
        super();
    ...
    public static instance(minecraftWss: WebSocketServer): MinecraftConnection {
        if (!this._instance) {
     ...
     */
    public requestCommand(command: string): void {
